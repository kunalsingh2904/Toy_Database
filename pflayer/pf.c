...
int error;
    ...
    if(fd!=prevfile||pagenum*PF_PAGE_SIZE-prevaddr!=4096) {
        nReadSeeks ++;// increment no of seeks by 1
        
    }
    prevfile = fd;
    prevaddr = pagenum*PF_PAGE_SIZE;
...
int error;
    ...
    if(fd!=prevfile||pagenum*PF_PAGE_SIZE-prevaddr!=4096) {
        nWriteSeeks ++;// increment no of seeks by 1
